        ...
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            <Route path="/aluno" element={<Layout />}>
              ...
              <Route path="/aluno/play-tv" element={<PrivateRoute><RoleRoute allowed={['aluno']}><PlayTvStudent /></RoleRoute></PrivateRoute>} />
              <Route path="/aluno/play-tv/:id" element={<PrivateRoute><RoleRoute allowed={['aluno']}><PlayTvVideoView /></RoleRoute></PrivateRoute>} />
            ...
            <Route path="/app" element={<Layout />}>
              ...
              <Route path="/app/play-tv" element={<PrivateRoute><RoleRoute allowed={['admin', 'tecadm', 'diretor', 'coordenador', 'professor']}><PlayTvManagement /></RoleRoute></PrivateRoute>} />
              <Route path="/app/play-tv/:id" element={<PrivateRoute><RoleRoute allowed={['admin', 'tecadm', 'diretor', 'coordenador', 'professor']}><PlayTvVideoView /></RoleRoute></PrivateRoute>} />
              ...
              <Route path="/app/cadastros/questao" element={<PrivateRoute><RoleRoute allowed={['admin', 'tecadm', 'diretor', 'coordenador', 'professor']}><QuestionsPage /></RoleRoute></PrivateRoute>} />
              <Route path="/app/cadastros/questao/criar" element={<PrivateRoute><RoleRoute allowed={['admin', 'tecadm', 'diretor', 'coordenador', 'professor']}><CreateQuestionPage /></RoleRoute></PrivateRoute>} />
              <Route path="/app/cadastros/questao/editar/:id" element={<PrivateRoute><RoleRoute allowed={['admin', 'tecadm', 'diretor', 'coordenador', 'professor']}><EditQuestionPage /></RoleRoute></PrivateRoute>} />
              <Route path="/app/cadastros/habilidades" element={<PrivateRoute><RoleRoute allowed={['admin', 'tecadm', 'diretor', 'coordenador', 'professor']}><HabilidadesPage /></RoleRoute></PrivateRoute>} />
