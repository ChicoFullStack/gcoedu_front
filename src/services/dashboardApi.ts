...
export class DashboardApiService {
   ...
   * O painel TecAdm usa /dashboard/comprehensive-stats em
   * fetchDashboardCountsByRole. O backend local não expõe /dashboard/tecadm.
   */
  static getTecAdmDashboard(): Promise<AdminDashboard | null> {
