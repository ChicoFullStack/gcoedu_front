 ...
 *
 * Tema padrão do app (sem tema da loja): azul (#2563EB) com verde de apoio.
 */
...
/** Padrão quando não há tema da loja (azul → verde) */
const defaultLight: SidebarThemeVars = {
  '--sidebar-bg': 'linear-gradient(to bottom, #93c5fd, #bfdbfe, #bbf7d0, #dcfce7)',
  '--sidebar-border': '#93c5fd',
  '--sidebar-icon-bg': '#bfdbfe',
  '--sidebar-icon-bg-hover': '#86efac',
  '--sidebar-icon-color': '#1e40af',
  '--sidebar-icon-color-active': '#2563EB',
  '--sidebar-text': '#1e3a8a',
  '--sidebar-text-muted': '#3b82f6',
  '--sidebar-link-hover-bg': 'rgba(147, 197, 253, 0.7)',
  '--sidebar-link-active-bg': '#86efac',
  ...
  '--sidebar-button-hover-bg': '#bbf7d0',
  '--sidebar-button-hover-text': '#166534',
  '--sidebar-focus-ring': 'rgba(37, 99, 235, 0.4)',
};

const defaultDark: SidebarThemeVars = {
  '--sidebar-bg': 'linear-gradient(to bottom, #0C4A6E, #075985, #166534, #14532d)',
  '--sidebar-border': 'rgba(147, 197, 253, 0.25)',
  '--sidebar-icon-bg': 'rgba(37, 99, 235, 0.2)',
  '--sidebar-icon-bg-hover': 'rgba(34, 197, 94, 0.25)',
  '--sidebar-icon-color': '#93c5fd',
  '--sidebar-icon-color-active': '#86efac',
  '--sidebar-text': 'rgba(255, 255, 255, 0.95)',
  '--sidebar-text-muted': 'rgba(191, 219, 254, 0.85)',
  '--sidebar-link-hover-bg': 'rgba(147, 197, 253, 0.15)',
  '--sidebar-link-active-bg': 'rgba(34, 197, 94, 0.3)',
  '--sidebar-link-active-text': '#dcfce7',
  '--sidebar-category-text': 'rgba(191, 219, 254, 0.75)',
  '--sidebar-user-card-bg': 'rgba(255, 255, 255, 0.05)',
  '--sidebar-user-card-border': 'rgba(147, 197, 253, 0.2)',
  '--sidebar-button-border': 'rgba(147, 197, 253, 0.4)',
  '--sidebar-button-hover-bg': 'rgba(37, 99, 235, 0.25)',
  '--sidebar-button-hover-text': '#bbf7d0',
  '--sidebar-focus-ring': 'rgba(37, 99, 235, 0.5)',
};
