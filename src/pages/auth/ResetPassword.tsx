        ...
        return (
            ...
            >
                <div className={`text-white w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12 transition-all duration-500 ${
                    isDark 
                        ? "bg-[#0C4A6E]" 
                        : "bg-gradient-to-br from-blue-600 via-sky-600 to-emerald-600"
                }`}>
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
                    <div className="w-full max-w-md text-center">
                        <div className={`relative flex flex-col ${
                            isDark 
                                ? "bg-[#0C4A6E] shadow-[7px_7px_10px_3px_rgba(36,0,70,0.16)]" 
                                : "bg-white/90 backdrop-blur-md shadow-xl"
                        } rounded-xl max-h-[420px] overflow-hidden p-6 animate-slide-in-right`}>
                            <Loader2 className={`h-16 w-16 animate-spin mx-auto mb-6 ${isDark ? "text-sky-400" : "text-[#3B82F6]"}`} />
                        ...
                        <div className={`relative flex flex-col ${
                            ...
                            <Button
                                ...
                                className={`w-[85%] h-10 mx-auto text-white font-bold border-none rounded cursor-pointer transition-all duration-300 animate-slide-in-up delay-300 ${
                                    isDark 
                                        ? "bg-[#1D4ED8] hover:bg-[#2563EB] hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50 active:scale-95" 
                                        : "bg-[#1D4ED8] hover:bg-[#2563EB] hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50 active:scale-95"
                                }`}
                            >
                                Ir para o login
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
                                <div className="relative group animate-slide-in-up delay-75">
                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none transition-transform duration-300 group-focus-within:scale-110">
                                        <Lock className={`h-5 w-5 transition-colors duration-300 ${isDark ? "text-gray-300 group-focus-within:text-sky-400" : "text-gray-400 group-focus-within:text-blue-600"}`} />
                                    </div>
                                    <Input
                                        ...
                                        className={`pl-10 h-10 bg-[#e0dede] border-none outline-none rounded transition-all duration-300 focus:scale-[1.02] focus:shadow-lg ${
                                            isDark 
                                                ? "bg-gray-700 text-white placeholder:text-gray-400 focus:bg-gray-600 focus:ring-2 focus:ring-blue-500/50" 
                                                : "bg-[#e0dede] text-gray-900 focus:bg-white focus:ring-2 focus:ring-blue-500/50"
                                        }`}
                                        value={newPassword}
                                    ...
                                    >
                                        {showPassword ? (
                                            <EyeOff className={`h-5 w-5 transition-all duration-300 ${isDark ? "text-gray-300 hover:text-sky-400" : "text-gray-400 hover:text-blue-600"}`} />
                                        ) : (
                                            <Eye className={`h-5 w-5 transition-all duration-300 ${isDark ? "text-gray-300 hover:text-sky-400" : "text-gray-400 hover:text-blue-600"}`} />
                                        )}
                                    </button>
                                </div>
                                ...
                                <Button
                                    ...
                                    className={`w-[85%] h-10 mx-auto mt-3 mb-2.5 text-white font-bold border-none rounded cursor-pointer transition-all duration-300 animate-slide-in-up delay-300 ${
                                        isDark 
                                            ? "bg-[#1D4ED8] hover:bg-[#2563EB] hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed" 
                                            : "bg-[#1D4ED8] hover:bg-[#2563EB] hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                                    }`}
                                    disabled={isLoading}
                                >
