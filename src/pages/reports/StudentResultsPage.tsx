      ...
      {isLoading ? (
        ...
        <Card className="border-dashed overflow-hidden">
          <CardContent className="py-10 sm:py-12 text-center">
            <div className="w-14 h-14 rounded-full bg-[#2563EB]/10 dark:bg-[#2563EB]/20 flex items-center justify-center mx-auto mb-4">
              {activeTab === "avaliacao" && <FileText className="h-7 w-7 text-[#2563EB]" aria-hidden />}
              {activeTab === "competicao" && <Award className="h-7 w-7 text-[#2563EB]" aria-hidden />}
              {activeTab === "olimpiada" && <Trophy className="h-7 w-7 text-[#2563EB]" aria-hidden />}
            </div>
