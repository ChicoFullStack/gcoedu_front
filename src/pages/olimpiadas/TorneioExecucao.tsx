...
const TorneioExecucao = () => {
  ...
  const finalizarTorneio = () => {
    ...
    toast({
      ...
      description: `Você acertou ${acertos}/${questoes.length} questões (${percentual.toFixed(1)}%)${recompensa > 0 ? ` e ganhou ${recompensa} GCOEDUCoins!` : ''}`,
    });
  };
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              ...
              <div className="p-4 bg-yellow-50 rounded-lg">
                ...
                <div className="text-sm text-yellow-700">Max GCOEDUCoins</div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              {recompensa > 0 && (
                <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                  <div className="text-2xl font-bold text-yellow-600">+{recompensa} GCOEDUCoins</div>
