  ...
  const loadUserContext = useCallback(async () => {
    ...
    try {
      ...
      setUserContext({
        ...
        municipio_nome: context.municipality?.name,
        municipio_estado: context.municipality?.state,
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="cadastrar">
            <CreatePlantaoForm
              ...
              userMunicipioName={userContext.municipio_nome}
              userMunicipioState={userContext.municipio_estado}
