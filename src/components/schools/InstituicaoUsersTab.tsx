                ...
                return (
                  <Card key={role} className="overflow-hidden">
                    <CardHeader className="py-3 px-4 bg-muted/50 border-b">
                      <h3 className="text-sm font-semibold text-[#2563EB] flex items-center gap-2">
                      ...
                      <div className="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-3">
                        {list.map((u) => (
                          <Card key={u.id} className={cn(
                            "overflow-hidden transition-all border-[#BFDBFE] dark:border-white/10",
                            "hover:border-[#2563EB]/40 hover:shadow-sm"
                          )}>
                              ...
                              <div className="flex items-start justify-between gap-3">
                                <div className="flex items-center gap-3 min-w-0 flex-1">
                                  ...
                                  {u.avatar_config ? (
                                    ...
                                    <div
                                      className="h-11 w-11 shrink-0 rounded-full bg-[#2563EB]/20 text-[#2563EB] dark:bg-[#2563EB]/30 dark:text-[#E3DFFF] flex items-center justify-center font-semibold text-lg"
                                      aria-hidden
                                    >
          ...
          {editingUser && (
            <div className="relative space-y-6 pt-2">
              ...
              {ROLES_WITH_SCHOOL.includes(editingUser.role) && getSchoolDisplay(editingUser) && (
                <div className="rounded-lg border border-[#BFDBFE] dark:border-white/10 bg-muted/30 px-4 py-3">
          ...
          <form onSubmit={handleAddAplicadorSubmit} className="space-y-4 pt-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="joao.silva@gcoedu.com.br"
                required
              />
            </div>
            <div className="space-y-2">
