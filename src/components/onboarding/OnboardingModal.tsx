    ...
    <Dialog open={open}>
      <DialogContent
        ...
        className={cn(
          ...
          "border-2 border-[#2563EB]/30 dark:border-[#a78bfa]/30",
          "bg-gradient-to-b from-background to-[#f5f0ff]/30 dark:to-[#1e1b4b]/30",
          "shadow-2xl shadow-[#2563EB]/10 dark:shadow-[#2563EB]/20",
      ...
      >
        <DialogHeader className="space-y-1 sm:space-y-2 text-center sm:text-left">
          <DialogTitle
            id="onboarding-title"
            className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#2563EB] to-[#a78bfa] bg-clip-text text-transparent"
          >
            Configure sua conta
          </DialogTitle>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <div className="flex-shrink-0">
                  <AvatarPreview
                    ...
                    size={120}
                    className="rounded-2xl border-4 border-[#2563EB]/20 dark:border-[#a78bfa]/30"
                  />
                </div>
                <div className="flex-1 w-full space-y-3">
                  ...
                  <Input
                    ...
                    className="border-[#2563EB]/30 focus:ring-[#2563EB]"
                  />
                  <Button
                    type="button"
                    variant="outline"
                    size="sm"
                    className="w-full border-[#2563EB]/40 text-[#2563EB] hover:bg-[#2563EB]/10"
                    onClick={() =>
                      updateConfig({
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          selected
                            ? `${t.color} border-[#2563EB]/50 dark:border-[#a78bfa]/50`
                            : "bg-muted/50 border-transparent hover:border-[#2563EB]/30"
                        )}
          ...
          <div className="w-full sm:w-auto">
            {step > 0 ? (
              <Button
                ...
                variant="outline"
                onClick={handleBack}
                className="w-full sm:w-auto border-[#2563EB]/40 text-[#2563EB] hover:bg-[#2563EB]/10"
                aria-label="Voltar"
              >
          ...
          <div className="w-full sm:w-auto">
            {isLastStep ? (
              <Button
                ...
                disabled={saving}
                className="w-full sm:w-auto bg-gradient-to-r from-[#2563EB] to-[#a78bfa] hover:opacity-90 text-white min-h-[44px]"
