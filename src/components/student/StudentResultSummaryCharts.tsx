...
const COLORS = ["#2563EB", "#16A34A", "#38BDF8", "#22C55E", "#0EA5E9"]
          ...
          <div className="mt-2 h-3 w-full rounded-full bg-muted overflow-hidden">
            <div
              className={`h-full rounded-full transition-all ${
                nota >= 9 ? "bg-gradient-to-r from-amber-400 to-amber-600" : nota >= 7 ? "bg-gradient-to-r from-emerald-400 to-emerald-600" : "bg-gradient-to-r from-[#2563EB] to-emerald-600"
              }`}
          ...
          {loadingEvolucao ? (
            ...
            <ResponsiveContainer width="100%" height={160}>
              <LineChart data={evolucaoLineData} margin={{ top: 8, right: 8, left: 8, bottom: 8 }}>
                ...
                <Line type="monotone" dataKey="nota" name="Nota" stroke="#2563EB" strokeWidth={2} dot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          )}
        </CardContent>
