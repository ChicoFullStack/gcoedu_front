...
const StudentFriendlyResultCard: React.FC<StudentFriendlyResultCardProps> = ({
  ...
  return (
    <Card className="border-[#2563EB]/20 dark:border-[#a78bfa]/30 shadow-md" aria-labelledby="result-card-title">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/50 min-h-[44px]">
            <BookOpen className="h-5 w-5 text-[#2563EB] flex-shrink-0" aria-hidden />
            <div className="min-w-0">
