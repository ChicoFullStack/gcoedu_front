...
const createUserFormSchema = (isEditing: boolean) => z.object({
  ...
  password: isEditing 
    ? z.string().min(8, "A senha deve ter pelo menos 8 caracteres").or(z.literal("")).optional()
                  ...
                  <FormItem>
                    ...
                    {!isEditing && (
                      <p className="text-xs text-muted-foreground">
                        ...
                        {!isChecking && isAvailable === null && "Gerado automaticamente (iniciais + @gcoedu.com.br)"}
                      </p>
                    )}
                    <FormMessage />
                  </FormItem>
                ...
                <FormItem>
                  ...
                  {!isEditing && (
                    <p className="text-xs text-muted-foreground">
                      ...
                      {!isChecking && isAvailable === true && "Email disponível."}
                      {!isChecking && isAvailable === false && "Email original em uso. Usando sugestão disponível."}
                      {!isChecking && isAvailable === null && "O email é gerado automaticamente pelas iniciais do nome + @gcoedu.com.br"}
                    </p>
                  )}
                  <FormMessage />
                </FormItem>
