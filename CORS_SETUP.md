...
## Problema
A aplicação estava tentando fazer requisições diretamente para `https://demo-api.gcoedu.com.br` do frontend rodando em `localhost:8080`, causando erros de CORS.
...
export VITE_API_BASE_URL=https://demo-api.gcoedu.com.br

# Ou criar um arquivo .env.local com:
echo "VITE_API_BASE_URL=https://demo-api.gcoedu.com.br" > .env.local
...
- `[GET] /api/users/school/... -> https://demo-api.gcoedu.com.br/api/users/school/...`
